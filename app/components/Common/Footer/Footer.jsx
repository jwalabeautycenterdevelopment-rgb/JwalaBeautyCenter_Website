                    ...
                    <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><Link href="#">Tools & Applications</Link></li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li>
                                    ...
                                    <a href="tel:04425350303" className="text_primary">044-2535 0303</a>
                                </li>
                                <li>
                                    <a href="tel:+919551222201" className="text_primary">+91 95512 22201</a>
                                </li>
                                <li>
                                    <a href="tel:+918925066671" className="text_primary">+91 89250 66671</a>
                                </li>
                                <li>
                                    <span className="font-medium">Email Id:</span>{" "}
                                    <a href="mailto:parrysbeauty2023@gmail.com" className="text_primary">
                                ...
                                <li>
                                    ...
                                    <span className="text_primary">
                                        #15, Evening Bazzar Road, Park Town, Chennai - 03
                                    </span>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="border-t border-gray-300 mt-10 pt-6  flex flex-col md:flex-row items-center justify-between text-sm text-gray-600  px-4 md:px-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4 mt-4 md:mt-0">
                        <div className="flex space-x-4 text-xl text-black">
                            ...
                            <a href="https://wa.me/919551222201" target="_blank" rel="noopener noreferrer">
                                <FaWhatsapp />
                            </a>
                        </div>
                    </div>
