                        ...
                        >
                            <div className="flex flex-col-reverse md:flex-row items-center">
                                <div className="w-full md:w-1/2 p-8 flex flex-col justify-center text-white">
                                    <span
                                        className="text-sm font-semibold py-2 px-4 rounded-full w-fit mb-3"
                                        style={{
                                            backgroundColor:
                                                deal?.bgColor === "#41263A"
                                                    ? "#F3BFE5"
                                    ...
                                    <h3 className="text-[32px] font-semibold leading-tight mb-3">
                                        {deal?.title}
                                    </h3>
                                    ...
                                    <button
                                        className="inline-flex items-center gap-2 font-semibold py-2 px-6 rounded-full transition-colors duration-300 w-fit"
                                        style={{
